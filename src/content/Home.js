        ...
        return (
            <div className="Home">
                ...
                <div className="Home-section Home-odd-section">
                    ...
                    <div className='Home-section-content'>
                    <ul>
                        <li><strong>Currently:</strong> Instructional Designer at <a href="https://www.kaggle.com" target="_blank" rel="noopener noreferrer">Kaggle</a></li>
                        <li><strong>Previously:</strong> Product Lead and Content Developer at <a href="https://www.udacity.com" target="_blank" rel="noopener noreferrer">Udacity</a></li>
                        <li><strong>Before that:</strong> PhD in Physics at UC Berkeley</li>
                    </ul>
                    </div>
                </div>
